...
- [x] **Landing page screenshots** — replaced all four placeholder divs in `LandingPage.jsx` with `<img>` tags: hero section (`hero-home.png.png`), solution split layout (`solution-belonging.png.png`), How It Works Tab 1 Record (`howitworks-evidence.png.png`), Tab 3 Report (`howitworks-report.png.png`). Tab 2 Analyse has no image yet — renders gracefully with conditional check. Files committed to `public/images/landing/`.
